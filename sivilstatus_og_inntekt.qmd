...
I denne oppgaven skal vi studere forholdet mellom sivilstatus og inntekt.
...
::: callout-note
## Foreslår å benytte hash-pipene label og cap-fig. Da får dere tilgang til kryssreferanser. Foreslår også geom_boxplot() istedenfor geom_jitter(). Gir mer og klarere informasjon til leseren. En facet_wrap() på kjønn får også frem kjønnsforskjellene.
:::
...
Dette er særlig påfallende for menn.
...
::: callout-note
## Igjen tror jeg geom_boxplot er bedre egnet. Anbefaler også bruk av quarto sitt kryssreferanse system.
:::
...
Mitt forslag figur 3.
Setter opp en facet_grid() mht.
kjønn og sivilstatus.
Benytter så geom_bar() for å vise fordelingen mellom de fire utdanningskategoriene.
...
::: callout-note
## Igjen vil jeg anbefale geom_boxplot() når dere bruker edu_fac (kategorivariabel). Hvis dere benytter education kan det være aktuelt med geom_point() og geom_smooth() med facet_grid sex og married.
:::
...
::: callout-note
## Foreslår geom_bar istedenfor geom_jitter
:::
